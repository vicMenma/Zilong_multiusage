    ...
    async def _edit(self) -> None:
        ...
        async with self._lock:
            try:
                ...
                log.warning("LivePanel edit uid=%d: %s", self._uid, exc)
            ...
            for attempt in range(2):
                try:
                    ...
                    if attempt == 0:
                        ...
                        log.warning("auto_panel uid=%d FloodWait retry — skipping", uid)
                except Exception as exc:
